...
L<lint.mk|https://github.com/zeppe-lin/pkgsrc/blob/master/lint.mk> in
pkgsrc repository,
...
default,
L<dhcpcd(8)|https://www.mankier.com/8/dhcpcd> run on all interfaces.
You can specify the interface, by modifying the C<OPTS> value in
F</etc/rc.d/dhcpcd> service file.
