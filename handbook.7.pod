...
L<Makefile|https://github.com/zeppe-lin/pkgsrc/blob/master/Makefile>
in B<pkgsrc> repository, L<finddeps-linked(1)>, and L<revdep(1)>.
...
To bring your local pkgsrc up to date use C<git pull>.  Example:
...
Pay attention to the file F<Makefile> in the root directory:

  $ cd /usr/src/pkgsrc
  $ ls
  COPYING    core/     Makefile   stuff/   xorg/
  COPYRIGHT  desktop/  README     system/

F<Makefile> will check packages' sources for some typical errors.
Type C<make> for more information.
