...
updates the B<grub> config.  We turn off the execution of this script
...
handling.  To address this, a front-end utility called
...
actually a POSIX L<sh(1p)|https://www.mankier.com/1p/sh> script, which
...
Pay attention to the file F<Makefile> in the root directory:
  ...
  COPYRIGHT  desktop/  README.md  system/
