...
<img src="https://zeppe-lin.github.io/images/logo.png"
  alt="Zeppe-Lin Logo" class="logo">
...
=head3 Download rootfs tarball
  ...
  # cd /mnt
  # wget -c https://github.com/zeppe-lin/pkgsrc/releases/download/2022-12-08/rootfs-2022-12-08-x86_64.tar.xz{,.sig}
