...
B<do not> fit into any of the collections above.  Since this
collection contains packages of different (often dubious) quality and
purpose, we will not use it in the examples.
...
Also, you may want to lock the B<linux> package and do not update it
