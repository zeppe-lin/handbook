...
It's also available on the Zeppe-Lin system as a
...
the Pkgfile in another package(s) since looking at examples is a great
way to learn.
...
it is generated (by L<pod2html(1pm)>) from the handbook, which is
