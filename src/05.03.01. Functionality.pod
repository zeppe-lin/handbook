...
=item Viewing dependency lists:
    ...
    [i]     attr 2.5.2-1: Extended attribute support library for ACL support
    [i]   ncurses 6.5-1: System V Release 4.0 curses emulation library
